...
public class OrderedList_inArraySlots
    ...
    public OrderedList_inArraySlots
        ...
        for (int idx = 0; idx < unordered.size(); idx++){
     ...
     */
     private int champIndex( ArrayList<Integer> challengers) {
        ...
        for (int idx = 0; idx < challengers.size(); idx++){
            Integer el = challengers.get(idx);
            if (el != null && el < champ){
                champ = el;
                // System.out.println(champ);
            }
        }
        return challengers.indexOf(champ);  // replace this line
     }
